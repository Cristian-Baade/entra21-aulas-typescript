...
console.log(animal1.habitat[0]);
console.log(animal1.getEspecie);
let animal2 = new Animal("Amazona", "Papagaio", 4.5, ["Ar", "Floresta"]);
console.log(animal2);
...
let professor1 = new Professor("Alex", 23, ["Historia", "Portugues", "Java"], 12, 80);
